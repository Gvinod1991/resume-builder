                ...
                <>
                  <Wrapper>
                    <>
                      ...
                      <Typography variant='p' className='text-gray-500 text-sm'>
                        ACE Online is an ed-tech startup that provides recorded
                        as well as live classes to engineering students who want
                        to appear GATE exam and other engineering-related
                        entrance tests for Engineering jobs in india.
                      </Typography>
                      <ul className='p-2 ml-5'>
                        <li className='list-disc text-sm p-1'>
                          CMS to manage the subjects,units,chapters and attach
                  ...
                  <Wrapper>
                    <>
                      ...
                      <Typography variant='p' className='text-gray-500 text-sm'>
                        Apnaklub provides a platform for resellers and traders
                        to resell inventory of fashion, Kitchen, and daily
                        essential goods.
                      </Typography>
                      <ul className='p-2 ml-5'>
                        <li className='list-disc text-sm p-1'>
                          Designed and developed the dashboard for the
                          operations team to manage products, inventories, and
                          order details. Operations team time saved by 40% when
                          this application is used as compared to manually
                          maintaining the excel sheets for inventory and
                          purchase orders of products from vendors.
                        </li>
                        <li className='list-disc text-sm p-1'>
                        ...
                        <li className='list-disc text-sm p-1'>
                          Led a team of 2 engineers to build the Progressive Web
                          App for the reseller to share and sell products to
                          their customers. Responsible for the whole app
                          architecture, planning, development, and deployment in
                          AWS EC2
                        </li>
                        <li className='list-disc text-sm p-1'>
                          Tech stack: ReactJs, Redux, AntD library, NodeJs,
                  ...
                  <Wrapper>
                    <>
                      ...
                      <Typography variant='p' className='text-gray-500 text-sm'>
                        Bookingjini Labs provides the dashboard, booking engine,
                        and chatbot service tools to hoteliers to manage their
                        properties which operate in India, Nepal, and Bhutan.
                      </Typography>
                      <ul className='p-2 ml-5'>
                        <li className='list-disc text-sm p-1'>
                          Built a portal to manage inventory of rooms and
                          distribution to various online travel agents(OTA) like
                          Booking.com and 7 other OTA's which helped reduce
                          overbooking by 5%.
                        </li>
                        <li className='list-disc text-sm p-1'>
                          Built the Booking Engine Web application using
                          ReactJs, Redux, NodeJs & ExpressJs with a team of 2
                          engineers. Revenue increased by 25% within the 1 month
                          of the launch of this application.
                        </li>
                        <li className='list-disc text-sm p-1'>
                          Built the mobile app (Android) to manage the inventory
                          and pricing of the hotel rooms by hoteliers using
                          React Native and Redux. Uploaded this application to
                          the google play store. Clients for the company
                          increased by 20%. Google Play Store Link.
                        </li>
                        <li className='list-disc text-sm p-1'>
                          Tech stack- ReactJs, React Native, Redux, NodeJs,
                          ExpressJs, and Mysql.
                        </li>
                      </ul>
                    </>
                  ...
                  <Wrapper>
                    <>
                      ...
                      <Typography
                        ...
                        className='text-gray-800 text-lg'
                      >
                        Siddha Development and Research Consultancy,
                        Bhubaneswar, India
                      </Typography>
                      <Typography
                        variant='h5'
                      ...
                      <Typography variant='p' className='text-gray-500 text-sm'>
                        SDRC provides web-based software applications to
                        agencies like UNICEF and various other social welfare
                        organizations as well as state governments in India.
                      </Typography>
                      <ul className='p-2 ml-5'>
                        <li className='list-disc text-sm p-1'>
                          Worked on the project called child labor tracking
                          system (CLTS), which is an innovative web-based system
                          to register child laborers and track their
                          re-integration to the mainstream.
                        </li>
                        <li className='list-disc text-sm p-1'>
                  ...
                  <Wrapper>
                    <>
                      ...
                      <Typography variant='p' className='text-gray-500 text-sm'>
                        ...
                        typing the word displayed within the time frame. By
                        playing this game typing speed of the user will be
                        enhanced and also new words can be learned.
                      </Typography>
